...
function cmb2_autoload_classes( $class_name ) {
	...
	get_template_part( "/inc/meta/includes/{$class_name}" );
}
...
function cmb2_get_metabox_form( $meta_box, $object_id = 0, $args = array() ) {
	...
	ob_start();
	// Get cmb form
	cmb2_echo_metabox_form( $cmb, $object_id, $args );
 ...
 * @param  array   $args      Optional arguments array
 */
function cmb2_echo_metabox_form( $meta_box, $object_id = 0, $args = array() ) {
	...
	$args = wp_parse_args( $args, array(
		...
		'save_button' => esc_html__( 'Save', 'accountant-wp' ),
	) );
...
function cmb2_metabox_form( $meta_box, $object_id = 0, $args = array() ) {
	if ( ! isset( $args['echo'] ) || $args['echo'] ) {
		cmb2_echo_metabox_form( $meta_box, $object_id, $args );
	} else {
