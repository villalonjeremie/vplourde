...
class CMB2 {
	...
	public function __construct( $meta_box, $object_id = 0 ) {
		...
		if ( empty( $meta_box['id'] ) ) {
			wp_die( esc_html__( 'Metabox configuration is required to have an ID parameter', 'accountant-wp' ) );
		}
	...
	public function render_group_row( $field_group, $remove_disabled ) {
		...
		<div class="postbox cmb-row cmb-repeatable-grouping" data-iterator="', $field_group->count(), '">
			...
			<button ', wp_kses_post($remove_disabled), 'data-selector="', esc_attr($field_group->id()), '_repeat" class="dashicons-before dashicons-no-alt cmb-remove-group-row"></button>
			<div class="cmbhandle" title="' , esc_html__( 'Click to toggle', 'accountant-wp' ), '"><br></div>
			...
			<div class="inside cmb-td cmb-nested cmb-field-list">';
				...
				<div class="cmb-row cmb-remove-field-row">
					<div class="cmb-remove-row">
						<button ', wp_kses_post($remove_disabled), 'data-selector="', esc_attr($field_group->id()), '_repeat" class="button cmb-remove-group-row alignright">', wp_kses_post($field_group->options( 'remove_button' )), '</button>
					</div>
				</div>
