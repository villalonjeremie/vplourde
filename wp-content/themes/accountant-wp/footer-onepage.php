	...
	<div id="footer" class="footer">
		<div class="container">
			<div class="row visible-xs visible-sm">
				<div class="col-sm-12 ">
					<div class="dropdown">
					  <a data-toggle="dropdown" href="#" class="show-link"><?php esc_html_e('About', 'accountant-wp'); ?></a>
				...
				<div class="col-sm-12 ">
					<div class="dropdown">
					  <a data-toggle="dropdown" href="#" class="show-link"><?php esc_html_e('Recent Posts', 'accountant-wp'); ?></a>
					  <div class="dropdown-menu" role="menu">
						<ul class="footerww">
				...
				<div class="col-sm-12 ">
					<div class="dropdown">
					  <a data-toggle="dropdown" href="#" class="show-link"><?php esc_html_e('Related Tags', 'accountant-wp'); ?></a>
					  <div class="dropdown-menu" role="menu">
					  	<ul class="footerww">
				...
				<div class="col-sm-12 ">
					<div class="dropdown">
					  <a data-toggle="dropdown" href="#" class="show-link"><?php esc_html_e('Contact Info', 'accountant-wp'); ?></a>
					  <div class="dropdown-menu" role="menu">
					  	<ul class="footerww">
...
<?php if(accountant_option('header_fixed')): ?>
	<span class="header-fixed-data header-fixed-data-true"></span>
<?php else: ?>

	<span class="header-fixed-data"></span>
<?php endif; ?>
